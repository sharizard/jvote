...
function Vote() {
  ...
  return (
    <div className="flex flex-col justify-center items-center space-y-10">
      <h1 className="text-6xl pb-10 text-fuchsia-100">
        Skal du på middagen idag?
      </h1>
      <div className="flex flex-row space-x-10">
        <button
          className="text-4xl border-fuchsia-100 border-2 p-4 text-fuchsia-100"
          onClick={(e) => addVote(true)}
        >
          JA! 😍
        </button>
        <h2 className="text-4xl text-center items-center flex text-fuchsia-100">{`Antall stemmer: ${yesVotes}`}</h2>
      </div>
      <div className="flex flex-row space-x-10">
        <button
          className="text-4xl border-fuchsia-100 border-2 p-4 text-fuchsia-100"
        ...
        <h2 className="text-4xl text-center items-center flex text-fuchsia-100">{`Antall stemmer: ${noVotes}`}</h2>
      </div>
    </div>
  );
}
